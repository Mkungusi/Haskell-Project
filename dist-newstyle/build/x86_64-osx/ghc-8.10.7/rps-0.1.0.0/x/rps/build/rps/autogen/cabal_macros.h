...
/* package rps-0.1.0.0 */
#ifndef VERSION_rps
#define VERSION_rps "0.1.0.0"
#endif /* VERSION_rps */
#ifndef MIN_VERSION_rps
#define MIN_VERSION_rps(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rps */
...
#define CURRENT_COMPONENT_ID "rps-0.1.0.0-inplace-rps"
